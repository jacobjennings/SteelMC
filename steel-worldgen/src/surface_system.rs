...
use crate::noise::{NormalNoise, PerlinSimplexNoise};
use crate::surface::{SurfaceBlockAccess, SurfaceNoiseProvider};
...
impl SurfaceSystem {
    ...
    #[must_use]
    pub fn eroded_badlands_extension<A: SurfaceBlockAccess>(
        &self,
        blocks: &mut A,
        local_x: usize,
        local_z: usize,
        ...
        for y in (min_y..=start_y).rev() {
            ...
            blocks.set_relative_block(local_x, rel_y, local_z, self.default_block);
        }
